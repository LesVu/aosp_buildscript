...
export USE_RBE=1
export RBE_DIR="$HOME/android/lineage/rbe" # Path to the extracted reclient directory (relative or absolute)
...
# export RBE_CXX_EXEC_STRATEGY=local # Important see below.
